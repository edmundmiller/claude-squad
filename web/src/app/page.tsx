    ...
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <div className={styles.headerActions}>
          <a
            ...
            href="https://github.com/smtg-ai/agent-fleet"
            target="_blank"
          ...
          <a
            href="https://github.com/smtg-ai/agent-fleet#readme"
            target="_blank"
            rel="noopener noreferrer"
            className={styles.headerButton}
          >
        ...
        <div className={styles.installation}>
          ...
          <div className={styles.codeBlockWrapper}>
            <pre className={styles.codeBlock}>
              <code>brew install agent-fleet</code>
            </pre>
            <CopyButton textToCopy="brew install agent-fleet" />
          </div>
          <br></br>
          <h3>Via Shell Script</h3>
          <div className={styles.codeBlockWrapper}>
            <pre className={styles.codeBlock}>
              <code>curl -fsSL https://raw.githubusercontent.com/smtg-ai/agent-fleet/main/install.sh | bash</code>
            </pre>
            <CopyButton textToCopy="curl -fsSL https://raw.githubusercontent.com/smtg-ai/agent-fleet/main/install.sh | bash" />
          </div>
      ...
      <footer className={styles.footer}>
        <p className={styles.copyright}>
          &copy; {new Date().getFullYear()} Agent Fleet. Licensed under <a href="https://github.com/smtg-ai/agent-fleet/blob/main/LICENSE.md" target="_blank" rel="noopener noreferrer">GNU AGPL v3.0</a>
        </p>
      </footer>
    </div>
  );
